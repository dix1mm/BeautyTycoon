...
public class WorkingTime : IWorkingTime{
    ...
    private readonly float _realSecondValueInGameMinutes = (_startHour-_endHour)*60 / _realTimeWorkDayDurationInSeconds;
    private DateTime _time = new DateTime();//а в .net 6 оказывается есть TimeOnly, возможно стоило сделать свой велосипед

    public string Time => _time.TimeOfDay.ToString();
    ...
    public void Update(float seconds){
        ...
        _time.AddMinutes(seconds * _realSecondValueInGameMinutes);
